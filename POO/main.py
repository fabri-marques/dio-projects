...
class Conta:
    ...
    def sacar(self, valor):
        if valor > self.saldo:
            ...
            self._saldo -= valor
            print("\n[OK] Saque efetuado com sucesso!")
            return True
        else:
            print("\n[ERRO] Valor inválido. Informe um valor positivo.")
        return False

    def depositar(self, valor):
        if valor > 0:
            self._saldo += valor
            print("\n[OK] Depósito efetuado com sucesso!")
            return True
        print("\n[ERRO] Valor inválido. Informe um valor positivo.")
        return False
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if valor > self._limite:
            print("\n[ERRO] O valor do saque ultrapassa o limite permitido.")
...
def recuperar_conta_cliente(cliente):
    if not cliente.contas:
        print("\n[ERRO] Este cliente não possui conta cadastrada.")
        return
...
def depositar(clientes):
    ...
    if not cliente:
        print("\n[ERRO] Nenhum cliente encontrado com esse CPF.")
        return
...
def criar_conta(numero_conta, clientes, contas):
    ...
    if not cliente:
        print("\n[ERRO] Cliente não encontrado. Cadastre o cliente antes de criar uma conta.")
        return
